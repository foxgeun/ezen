        ...
        function ss() {
         ...
         for (let e = 0; e <= 5; e++) {
           if (data.results[i].genre_ids[e] == 16) {
             $(".movie_con").append(
               `<a class=act href="https://www.themoviedb.org/movie/${data.results[i].id}"><img class="movie_img" src="${imgURL}"></img><h1 class="movie_ex">${data.results[i].title}</h1></a>`
             );
           }
         }
        }
        ...
        function dd() {
          ...
          for (let e = 0; e <= 5; e++) {
            if (data.results[i].genre_ids[e] == 28) {
              $(".movie_con1").append(
                `<a class=mi href="https://www.themoviedb.org/movie/${data.results[i].id}"><img class="movie_img" src="${imgURL}"></img><h1 class="movie_ex">${data.results[i].title}</h1></a>`
              );
            }
          }
        }
        ...
        function qq() {
          ...
          for (let e = 0; e <= 5; e++) {
            if (data.results[i].genre_ids[e] == 27) {
              $(".movie_con2").append(
                `<a class=ho href="https://www.themoviedb.org/movie/${data.results[i].id}"><img class="movie_img" src="${imgURL}"></img><h1 class="movie_ex">${data.results[i].title}</h1></a>`
              );
            }
          }
        }
